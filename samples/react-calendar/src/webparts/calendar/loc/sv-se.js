define([], function () {
    return {
      ...
      ConfirmeDeleteAllRecurrrencesMessage: "Bekräfta borttag av händelse ? Om händelsen är en återkommande händelse kommer alla tillfällen att raderas ",
      ConfirmeDeleteOneRecurrenceMessage: "Bekräfta borttag av händelse ? Endast den här händelsen raderas, alla andra återkommande raderas inte ",
